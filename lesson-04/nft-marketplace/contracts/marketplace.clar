...
(define-constant ERR_DUPLICATED_VALUE (err 2009))

;; Define a map data structure for the asset listings map<uint, tupla>
(define-map listings
  uint
  {
    maker: principal,
...
(define-public (set-whitelisted (asset-contract principal) (whitelisted bool))
  (begin
    (asserts! (is-none (map-get? whitelisted-asset-contracts asset-contract)) ERR_UNAUTHORISED) ;; check duplicated assets
